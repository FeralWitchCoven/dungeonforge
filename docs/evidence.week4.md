...
**How many places construct a Monster?** _1_   **Which class?** _GameWorld.java_

**Look at `before.txt`. List the species that appear on level 1, and on level 3:**

- Level 1: Skeleton, Wight, Crypt Rat, Bone Priest
- Level 3: Wight, Bone Priest

**In one sentence: what is the player's experience of descending from level 1 to level 3?**

The experience doesn't change. It's pretty much the same Monsters and level. Only HP and Attack numbers change.
