...
public class SingletonTest {
    ...
    @Test
    void theSameSeedProducesTheSameSeedSquence() {
    ...
    @Test
    void theDifferentSeedProducesADifferentSeedSquence() {
    ...
    void theSameSeedProducesTheSameDungeon() {
        RandomSource.getInstance().reseed(12345L);
        int monstersFirstRun = new GameWorld(new Player("Alpha")).totalMonsters();

        RandomSource.getInstance().reseed(12345L);
        int monstersSecondRun = new GameWorld(new Player("Beta")).totalMonsters();
